...
class AlbumsRouter: NSObject, AlbumsRoutingLogic, AlbumsDataPassing {
	...
	//func navigateToSomewhere(source: AlbumsViewController, destination: SomewhereViewController)
	//{
	...
	//func passDataToSomewhere(source: AlbumsDataStore, destination: inout SomewhereDataStore)
	//{
